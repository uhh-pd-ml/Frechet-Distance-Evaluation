...
#from models.constrainer_5_layer_FC_dropout_BN import Regressor
from models.constrainer_5_layer_FC_dropout_BN_frechet_woBatchNorm import Regressor
...
num_epochs = 400 #50 #100 #200   ### zum testen 2, später 200 sinnvoll
...
saving_path = '/beegfs/desy/user/werthern/Regression/For_Nana/Output/Test_regressor+_woBatchNorm/Test_regressor+_woBatchNorm_2{}.pt'   
...
net = Regressor().to(device) #netC_Ang
...
experiment.add_tag('ba_regressor+_woBatchNorm_2')
...
plt.savefig('/beegfs/desy/user/werthern/Regression/For_Nana/Output/plots/loss_Test_regressor+_woBatchNorm_2.png')
...
plt.savefig('/beegfs/desy/user/werthern/Regression/For_Nana/Output/plots/acuracy_Test_regressor+_woBatchNorm_2.png')       
