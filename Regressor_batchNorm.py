...
from models.getting_high_constrainer_batchNorm import energyRegressor
...
num_epochs = 250 #50 #100 #200   ### zum testen 2, später 200 sinnvoll
...
saving_path = '/beegfs/desy/user/werthern/Regression/For_Nana/Output/Regressor_batchNorm_B/Regressor_batchNorm_B_{}.pt'   
...
experiment.add_tag('ba_regression_Regressor_batchNorm_B')
...
plt.savefig('/beegfs/desy/user/werthern/Regression/For_Nana/Output/plots/loss_Regressor_batchNorm_B.png')
...
plt.savefig('/beegfs/desy/user/werthern/Regression/For_Nana/Output/plots/acuracy_Regressor_batchNorm_B.png')       
